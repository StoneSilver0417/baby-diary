...
1. [ ] **v0.11.5 배포 후** 와이프 아이폰에서 줄노트 배경선이 보이는지 최종 확인 (원인=v0.10.7의 seam-flush 회귀로 확정, off-seam으로 수정 배포함. 데스크톱 재현 불가 항목이라 실기기 스크린샷이 유일한 검증 수단)
